...
const products = [
  {
    name: "Analytics",
    description: "See how SynX assets are doing!",
    href: "#",
    icon: ChartPieIcon,
  },
  {
    name: "Engagement",
    description:
      "Join our community and improve your investments. Learn to diversify, manage risk and automate strategies. ",
    href: "#",
    icon: CursorArrowRaysIcon,
  },
  {
    name: "Security",
    description: "Learn how SynX takes care of your investment safety.",
    href: "#",
  ...
  return (
    <header className="bg-white px-4 py-5">
      ...
      >
        ...
        {/* Navigation Links (02) */}
        <Popover.Group className="hidden lg:flex lg:gap-x-12 justify-center flex-1">
          <Popover>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">SynX</span>
              <img
